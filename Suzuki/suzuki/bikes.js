...
import bikewise_variant from './bikewise_variant';
...
function bikes( navigation)  {

    const [showModal, setShowModal] = useState(false);

    const [value, setValue] = useState(null);
    const [isFocus, setIsFocus] = useState(false); // catagories value

    const [model_name, setModel_name] = useState('');  // name
    const [imageSource, setImageSource] = useState(null);   // model logo
    const [imageSource2, setImageSource2] = useState(null);   // model campion img
    const [imageSource3, setImageSource3] = useState(null);  // uplode browhcher file
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
        ...
        borderWidth: 1,
        borderRadius: 10,
        padding: 10,}}  placeholder="Enter Models name" placeholderTextColor='black'
        value={model_name}
        onChangeText={(text)=>setModel_name(text)} 
        />
...
<View style={{ flex: 1,
    ...
    marginBottom: 10,color:'black',}}>Models logo</Text>
    ...
    alignItems: 'center',}}>
      <Text style={{fontSize: 16,color:'black',
    marginBottom: 10,}}>Models campaign image</Text>
      {imageSource3 && <Image source={imageSource3} style={{width: 200,
    height: 200,
    resizeMode: 'contain',
    marginTop: 20,
    marginBottom:10}} />}
      <Button title=" uplode Models campaign image" onPress={selectImage3} />
    </View>
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0,color:'black', }}>Models</Text>
  </View>
...
<DataTable style={styles.container}>
   ...
   />
        ...
        <Link to={{ screen: 'bikewise_variant', params: { id: 'bikewise_variant' } }}  style={{}}>
