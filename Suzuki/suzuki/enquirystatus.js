...
function enquirystatus( navigation)  {

    const [showModal, setShowModal] = useState(false);
   
    const [enquirystatus_name, setEnquirystatus_name] = useState('');
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{borderColor:'', borderWidth: 0, backgroundColor:'',
            shadowColor: '',}}>
        <Text style={{ fontSize:20,  fontWeight:"900",resizeMode: 'cover', color:'blue',marginLeft:20}}> Add New Enquiry Status</Text>
    </View>


    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
                <Text style={{fontWeight:600,fontSize:15,marginTop:0,color:'black',}}>
                Enquiry status name * :</Text>
            </View>
            <TextInput style={{ borderColor: "gray",color:'black',
        width: "100%",
        borderWidth: 1,
        borderRadius: 10,
        padding: 10,}}  placeholder="Enter Enquiry status name" placeholderTextColor='black' 
        value={enquirystatus_name}
        onChangeText={(text)=>setEnquirystatus_name(text)} 
        />
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0, color:'black',}}>Enquiry Status</Text>
  </View>
...
<DataTable style={styles.container}>
      ...
      <DataTable.Row>
        <DataTable.Cell  style={{}}> Booking Done  </DataTable.Cell>
