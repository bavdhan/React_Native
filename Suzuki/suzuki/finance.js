...
function finance( navigation)  {
    ...
    const [finance_partner_name, setFinance_partner_name] = useState('');
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{borderColor:'', borderWidth: 0, backgroundColor:'',
            shadowColor: '',}}>
        <Text style={{ fontSize:20,  fontWeight:"900",resizeMode: 'cover', color:'blue',marginLeft:30}}> Create Financer</Text>
    </View>


    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
                <Text style={{fontWeight:600,fontSize:15,marginTop:0,color:'black',}}>
                Finance partner name  :</Text>
            </View>
        ...
        borderRadius: 10,
        padding: 10,}} 
        value={finance_partner_name}
        onChangeText={(text)=>setFinance_partner_name(text)} 
        />
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0,color:'black', }}>Financers</Text>
  </View>
...
<DataTable style={styles.container}>
      <DataTable.Header style={styles.tableHeader}>
        <DataTable.Title style = {{marginRight:0,marginLeft:0}}>Financers Name</DataTable.Title>
        <DataTable.Title style = {{marginRight:0,marginLeft:0}}>Edit / Delete</DataTable.Title>
