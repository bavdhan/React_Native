...
<View style={{ flexDirection: 'column',
  ...
  <Text style={{ fontWeight:700,fontSize:22,marginTop:0,color:'black', }}>All Inventory / Stock</Text>
  </View>
 ...
 <Text style={{fontSize:12,  fontWeight:"600",resizeMode: 'cover', color:'white'}} > 🚀Create Invntory</Text>
  ...
  <Text style={{ fontWeight:700,fontSize:15,marginTop:0,color:'black',marginLeft: 50, }}>Total Inventory : 142</Text>
