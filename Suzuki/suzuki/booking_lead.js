...
import edit_doket from './edit_doket';



function booking_lead( navigation)  {
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0, color:'black', }}>BOOKINGS </Text>
  </View>
...
<DataTable style={styles.container}>
      ...
      <DataTable.Row>
        <DataTable.Cell  style={{}}> Vinod Chwake  </DataTable.Cell>
...
<Link to={{ screen: 'pement', params: { id: 'pement' } }}  style={styles.cbut}>
        ...
        <View style={{flexDirection:'column'}}>
        <Link to={{ screen: 'edit_booking', params: { id: 'edit_booking' } }}  style={styles.cbut1}>
          <Text style={{fontSize:12,
        fontWeight:"600", color:'black'}}
        >  Edit order form  </Text> </Link>
       

        
        <Link to={{ screen: 'edit_doket', params: { id: 'edit_doket' } }}  style={styles.cbut1}>
          <Text style={{fontSize:12,
        fontWeight:"600", color:'black'}}
        > Edit Doket  </Text> </Link>
