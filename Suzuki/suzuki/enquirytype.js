...
function enquirytype( navigation)  {

    const [showModal, setShowModal] = useState(false);

    const [enquiry_type_name, setEnquiry_type_name] = useState('');
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{borderColor:'', borderWidth: 0, backgroundColor:'',
            shadowColor: '',}}>
        <Text style={{ fontSize:20,  fontWeight:"900",resizeMode: 'cover', color:'blue',marginLeft:30,}}> Add New Enquiry Type</Text>
    </View>


    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
                <Text style={{fontWeight:600,fontSize:15,marginTop:0,color:'black',}}>
                Enquiry Type name * :</Text>
            </View>
            <TextInput style={{ borderColor: "gray",color:'black',
        width: "100%",
        borderWidth: 1,
        borderRadius: 10,
        padding: 10,}}  placeholder="Enter Enquiry Type name*" placeholderTextColor='black'
        value={enquiry_type_name}
        onChangeText={(text)=>setEnquiry_type_name(text)} 
        />
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0,color:'black', }}>Enquiry Types</Text>
  </View>
...
<DataTable style={styles.container}>
      ...
      <DataTable.Row>
        <DataTable.Cell  style={{}}> Walk-In  </DataTable.Cell>
