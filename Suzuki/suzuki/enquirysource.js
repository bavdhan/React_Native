...
function enquirysource( navigation)  {

    const [showModal, setShowModal] = useState(false);

    const [enquiry_source_name, setEnquiry_source_name] = useState('');
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{borderColor:'', borderWidth: 0, backgroundColor:'',
            shadowColor: '',}}>
        <Text style={{ fontSize:20,  fontWeight:"900",resizeMode: 'cover', color:'blue',marginLeft:30}}> Add New Enquiry Source</Text>
    </View>


    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
                <Text style={{fontWeight:600,fontSize:15,marginTop:0,color:'black'}}>
                Enquiry source name * :</Text>
            </View>
            <TextInput style={{ borderColor: "gray",color:'black',
        width: "100%",
        borderWidth: 1,
        borderRadius: 10,
        padding: 10,}}  placeholder="Enter Enquiry source name*"   placeholderTextColor='black'
        value={enquiry_source_name}
        onChangeText={(text)=>setEnquiry_source_name(text)} 
        />
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0,color:'black', }}>Enquiry Sources</Text>
  </View>
...
<DataTable style={styles.container}>
      <DataTable.Header style={styles.tableHeader}>
        ...
        <DataTable.Title style = {{marginRight:0,marginLeft:0}}>Action</DataTable.Title>
      ...
      <DataTable.Row>
        <DataTable.Cell  style={{}}> Charges  </DataTable.Cell>
        <DataTable.Cell  style = {{ marginLeft:70 ,marginRight:70}}> 	 <Link to={{ screen: '', params: { id: '' } }}  style={{ }}>
        ...
        >    Delete </Text> </Link> </DataTable.Cell>
