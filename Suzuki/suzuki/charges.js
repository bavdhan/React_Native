...
function charges( navigation)  {

    const [showModal, setShowModal] = useState(false);

    const [charge_label, setCharge_label] = useState('');   // charge lablel
...
<View style={{margin:10,padding:10}}>
    ...
    <View style={{borderColor:'', borderWidth: 0, backgroundColor:'',
            shadowColor: '',}}>
        <Text style={{ fontSize:20,  fontWeight:"900",resizeMode: 'cover', color:'blue',marginLeft:30}}> Add New Charge</Text>
    </View>
    ...
    <View style={{marginTop:20,flexDirection:'row',marginBottom:10}}>
        ...
        borderWidth: 1,
        borderRadius: 10,
        padding: 10,}}  placeholder="Enter Charge label" placeholderTextColor='black'
        value={charge_label}
        onChangeText={(text)=>setCharge_label(text)} 
        />
...
<View style={{ flexDirection: 'column',
    ...
    alignItems: 'center',
    marginTop:10}}>
  <Text style={{ fontWeight:700,fontSize:20,marginTop:0,color:'black', }}>Charge Labels</Text>
  </View>
...
<DataTable style={styles.container}>
      ...
      <DataTable.Row>
        <DataTable.Cell  style={{}}> Ex. Warranty  </DataTable.Cell>
        <DataTable.Cell  style = {{ marginLeft:50 ,marginRight:70}}> 	 <Text style={{fontSize:15,
